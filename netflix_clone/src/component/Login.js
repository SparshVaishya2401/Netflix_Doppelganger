...
// } Another method used used for passwordOnChangeHandler in line 38
...
return(
    <div className="login">
         <div className="holder">
            ...
            <br/>
            <br/>
            { isUserExist && <p className="text-danger">User does not exist | Go Signup</p> }
            { isEmailUsed && <p className="text-danger">Email Already in use | Go Sign In</p> }

            <div className="login-form-other">
                <div className="login-sign-now">
